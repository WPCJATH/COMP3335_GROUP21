...
?>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="index.php?checkin">
    ...
    <main id="main" class="main">
        ...
        <section class="section profile">
            ...
            $sql = "SELECT `RES_ID`, `CUS_ID`, `CHECKIN_DATE`, `DURATION`, `ROOM_TYPE`, `AMT`, `RESPONSE`, `ROOM_NUMBER` 
                FROM `RESERVATION` WHERE  `IS_ORDER`=true AND `ROOM_NUMBER` IS NOT NULL;";
             ...
             <div class="card">
                ...
                <form class="row">
                    ...
                    <div class="col-lg-6 profile-edit profile-overview pt-3">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 label">Room Number</div>
                            <div class="col-lg-6 col-md-8">ROOM $room_number</div>
                        </div>
                        
                        <div class="row" id="insert$res_id">
                            <div class="col-lg-4 col-md-4 label">Acceptor</div>
                            <div class="col-lg-6 col-md-8">$response</div>
                        </div>


                        <div class="row mb-3">
                            <div class="col-sm-10">
                                <button class="btn btn-primary" id="confirm_btn$res_id" type="submit">Check Out</button>
                            </div>
                        </div>
                        <script>
                            document.getElementById("confirm_btn$res_id").onclick = function(){
                                let json_data = '{' +
                                    ...
                                    '"room_no" : "' + $room_number + '"' +
                                '}';
                                return update_checkout(JSON.parse(json_data), "insert$res_id");
                            }
    ...
    <script>
        ...
        function update_checkout(json_data, alert_id){
            $.ajax({
                url: 'index.php?update_checkout',
                type : "POST",
                dataType : 'json',
                data : json_data,
                success: function(results) {
                    ...
                    if (results.status === 1){
                        ...
                        window.location.replace("index.php?checkout");
                    }
                    else{
