...
DROP VIEW IF EXISTS `CL_PROFILE`;
DROP VIEW IF EXISTS `FD_PROFILE`;
DROP VIEW IF EXISTS `CUS_PROFILE`;
DROP VIEW IF EXISTS `CUS_RESERVATION`;
DROP VIEW IF EXISTS `STAFF_RESERVATION`;
DROP VIEW IF EXISTS `TRAVEL_PARTNER_VIEW`;
DROP VIEW IF EXISTS `TRAVEL_PARTNER_INORDER_VIEW`;
...
CREATE ALGORITHM =
    UNDEFINED DEFINER = `root`@`localhost`
...
CREATE ROLE IF NOT EXISTS 'CUSTOMER'@'localhost';
...
GRANT CREATE USER, RELOAD, SUPER, GRANT OPTION ON *.* TO 'computer'@'localhost';
GRANT SELECT ON mysql.user TO 'computer'@'localhost';
GRANT CREATE USER, RELOAD, SUPER, GRANT OPTION ON *.* TO 'MANAGER'@'localhost' WITH GRANT OPTION;
GRANT SELECT ON mysql.user TO 'MANAGER'@'localhost' WITH GRANT option;
...
GRANT SELECT, UPDATE, INSERT, DELETE ON hotel.ROOM_TYPE TO 'MANAGER'@'localhost' WITH GRANT OPTION;
GRANT SELECT ON hotel.ROOM_TYPE TO 'CLEANER'@'localhost';
GRANT SELECT ON hotel.ROOM_TYPE TO 'CUSTOMER'@'localhost';
...
*/
GRANT SELECT ON hotel.STAFF TO 'FRONT_DESK'@'localhost';
GRANT SELECT ON hotel.STAFF TO 'CLEANER'@'localhost';
GRANT SELECT, UPDATE, INSERT, DELETE ON hotel.STAFF TO 'MANAGER'@'localhost' WITH GRANT OPTION;

-- room --
GRANT SELECT, UPDATE ON hotel.ROOM TO 'FRONT_DESK'@'localhost';
GRANT SELECT, UPDATE, INSERT, DELETE ON hotel.ROOM TO 'MANAGER'@'localhost' WITH GRANT OPTION;
GRANT SELECT, UPDATE ON hotel.ROOM TO 'CLEANER'@'localhost';
GRANT SELECT ON hotel.ROOM TO 'CUSTOMER'@'localhost';
...
GRANT SELECT, UPDATE, INSERT, DELETE ON hotel.CUSTOMER TO 'CUSTOMER'@'localhost';

-- travel_partner --
GRANT SELECT, UPDATE, INSERT, DELETE ON hotel.TRAVEL_PARTNER TO 'computer'@'localhost' WITH GRANT OPTION ;
GRANT SELECT, UPDATE, INSERT, DELETE ON hotel.TRAVEL_PARTNER TO 'CUSTOMER'@'localhost';
...
GRANT SELECT, UPDATE, INSERT, DELETE ON hotel.TRAVEL_PARTNER_INORDER TO 'CUSTOMER'@'localhost';


-- reservation --
/*
GRANT SELECT, UPDATE ON hotel.reservation_column_wise_privileges_fds_and_mas TO 'FRONT_DESK'@'localhost';
GRANT SELECT, UPDATE, INSERT ON hotel.reservation_column_wise_privileges_fds_and_mas TO 'MANAGER'@'localhost' WITH GRANT OPTION;
GRANT SELECT ON hotel.reservation_column_wise_privileges_cleaners TO 'CLEANER'@'localhost';
GRANT SELECT, UPDATE, INSERT ON hotel.reservation_column_wise_privileges_fds_and_mas TO 'CUSTOMER'@'localhost';
*/

GRANT SELECT, UPDATE, INSERT, DELETE ON hotel.RESERVATION TO 'computer'@'localhost' WITH GRANT OPTION ;
GRANT SELECT, UPDATE, INSERT, DELETE ON hotel.RESERVATION TO 'CUSTOMER'@'localhost';
GRANT SELECT, UPDATE ON hotel.RESERVATION TO 'FRONT_DESK'@'localhost';
GRANT SELECT, UPDATE ON hotel.RESERVATION TO 'MANAGER'@'localhost' WITH GRANT OPTION;


GRANT 'FRONT_DESK'@'localhost'  TO 'MANAGER'@'localhost';
GRANT 'CLEANER'@'localhost'  TO 'MANAGER'@'localhost';
GRANT 'CUSTOMER'@'localhost' TO 'computer'@'localhost';
SET DEFAULT ROLE ALL TO 'computer'@'localhost';
...
CREATE USER IF NOT EXISTS 'David'@'localhost' IDENTIFIED BY '12345678';
CREATE USER IF NOT EXISTS 'Ewing'@'localhost' IDENTIFIED BY '12345678';
CREATE USER IF NOT EXISTS 'Frank'@'localhost' IDENTIFIED BY '12345678';

-- Grant Roles --
GRANT 'MANAGER'@'localhost' TO 'Alice'@'localhost';
GRANT 'FRONT_DESK'@'localhost' TO 'Alice'@'localhost';
GRANT 'CLEANER'@'localhost' TO 'Alice'@'localhost';
...
-- SET DEFAULT ROLE 'FRONT_DESK'@'localhost' ALL TO 'Bob'@'localhost';
GRANT 'CLEANER'@'localhost' TO 'Chris'@'localhost';
-- SET DEFAULT ROLE 'CLEANER'@'localhost' ALL TO 'Chris'@'localhost';
GRANT 'CUSTOMER'@'localhost' TO 'David'@'localhost';
GRANT 'CUSTOMER'@'localhost' TO 'Ewing'@'localhost';
GRANT 'CUSTOMER'@'localhost' TO 'Frank'@'localhost';
